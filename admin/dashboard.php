                            ...
                            <?php foreach ($recent_users as $user): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-sm" style="background: #dc3545; color: white;" onclick="deductAccount(<?php echo $user['id']; ?>, '<?php echo htmlspecialchars($user['first_name'] . ' ' . $user['last_name'], ENT_QUOTES); ?>', <?php echo $user['account_balance']; ?>)">Deduct</button>
    ...
    <div id="deductModal" class="modal">
        <div class="modal-content">
            ...
            <form id="deductForm">
                ...
                <div class="form-group">
                    <label>User: <span id="deduct_user_name"></span></label>
                </div>
                <div class="form-group">
                    <label>Current Balance: <span id="deduct_current_balance"></span></label>
                </div>
                <div class="form-group">
                    <label>Amount to Deduct</label>
                    <input type="number" id="deduct_amount" name="amount" step="0.01" min="0.01" required>
                </div>
                <div class="form-group">
                    <label>Reason / Description</label>
                    <textarea id="deduct_description" name="description" rows="3" required placeholder="Enter reason for deduction..."></textarea>
                </div>
                <div style="display: flex; gap: 10px; margin-top: 20px;">
                    <button type="submit" class="btn" style="flex: 1; background: linear-gradient(135deg, #dc3545 0%, #a71d2a 100%); color: white;">Deduct Fund</button>
                    <button type="button" class="btn btn-danger" onclick="closeDeductModal()" style="flex: 1;">Cancel</button>
                </div>
            </form>
        </div>
    </div>
