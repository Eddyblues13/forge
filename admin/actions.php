    ...
    switch ($action) {
        ...
        case 'deduct_account':
            ...
            if ($amount > $balance_before) {
                $pdo->rollBack();
                echo json_encode(['success' => false, 'message' => 'Deduction amount exceeds current balance of $' . number_format($balance_before, 2)]);
                exit;
            }
            ...
            $stmt->execute([
                ...
                $balance_before,
                $balance_after,
                $description ?: 'Account deduction by admin',
                $admin_id
            ]);
